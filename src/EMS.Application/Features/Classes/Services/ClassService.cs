    ...
    public class ClassService : IClassService
    {
        ...
        public async Task<Guid> CreateClassAsync(CreateClassDto request)
        {
            ...
            var newClass = new Class
            {
                ...
                BillingMethod = string.IsNullOrWhiteSpace(request.BillingMethod) ? null : request.BillingMethod,
                BillingCycle = string.IsNullOrWhiteSpace(request.BillingCycle) ? "Monthly" : request.BillingCycle,
                PaymentDeadlineDays = request.PaymentDeadlineDays,
                TuitionNote = string.IsNullOrWhiteSpace(request.TuitionNote) ? null : request.TuitionNote,
                Status = "Scheduled",
                IsDeleted = false,
